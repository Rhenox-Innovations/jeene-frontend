...
const EditRatingParameterLayer = () => {
  ...
  const submitHandler = async (e) => {
    ...
    if(validate()){
        ...
        try{
            const result = await apiRequest.put(Endpoints.UPDATE_RATING_PARAMETER, requestData);
            setLoading(false)
      ...
      <div className="card-body p-24">
        <div className="row justify-content-center">
          ...
          {showSuccess && <div
                            ...
                            role="alert"
                        >
                            Rating Parameter updated successfully!
...
export default EditRatingParameterLayer;